...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_pindah_activity_data:
                ...
                moveWithDataIntent.putExtra("extra_name", " Geofany Hermawan");
                moveWithDataIntent.putExtra("NIM", "E41191593");
                startActivity(moveWithDataIntent);
                break;

            case R.id.btn_dial:
                String phoneNumber = "0083847175446";
            ...
            case R.id.btn_share_text:
                ...
                break;
            case R.id.btn_sms:
                Intent sms = new Intent(Intent.ACTION_SENDTO, Uri.parse("smsto: 083847175446"));
                sms.putExtra("sms_body", "Mari Belajar Implicit dan Explicit ");
                startActivity(sms);
                break;

            case R.id.btn_activity_result:
                Intent moveForResultIntent = new Intent(this, com.example.minggu61.PindahForResult.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE){
            if (resultCode == com.example.minggu61.PindahForResult.RESULT_CODE){
                int selectedValue = data.getIntExtra(com.example.minggu61.PindahForResult.EXTRA_VALUE, 0);
