...
<head>
  ...
  <link href="{{asset('backend/assets/fullcalendar/fullcalendar/bootstrap-fullcalendar.css')}}" real="stylesheet" />
  <link href="{{asset('backend/assets/fullcalendar/fullcalendar/fullcalendar.css')}}" real="stylesheet" />
